...
public class MySQLAccess {
    ...
    public void addAdData(Ad ad) throws Exception {
        ...
        try {
            ...
            ad_info.setInt(1, ad.adId);
            ad_info.setInt(2, ad.campaignId);
    ...
    public Ad getAdData(int adId) throws Exception {
        ...
        try {
            ...
            while (result_set.next()) {
                ad.adId = result_set.getInt("adId");
                ad.campaignId = result_set.getInt("campaignId");
    ...
    public void addCampaignData(Campaign campaign) throws Exception {
        ...
        try {
            ...
            camp_info.setInt(1, campaign.campaignId);
    ...
    public Double getBudget(int campaignId)  throws Exception {
    ...
    public void updateCampaignData(int campaignId,Double newBudget) throws Exception {
